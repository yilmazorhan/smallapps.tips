...
public class FindProductGroupQuery   {
  @JsonProperty("name")
  private String name;

  public FindProductGroupQuery name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=2,max=255) 
  ...
  public boolean equals(Object o) {
    ...
    FindProductGroupQuery findProductGroupQuery = (FindProductGroupQuery) o;
    return Objects.equals(this.name, findProductGroupQuery.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class FindProductGroupQuery {\n");
